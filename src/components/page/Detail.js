import "./detail.css";
import mateBookCode from "./matebook_code.png";
...
export function Detail() {
  return (
    <div className="detail-block">
      <div>
        <img className="detail-img" src={mateBookCode} alt="" />
      </div>
      <div className="detail-content">
        <div className="detail-title">
          <h1 className="detail-sub-title">Finibus Bonorum et Malorum</h1>
          <span className="detail-author">Written by John doe</span>
          <span className="detail-time">Monday May 20</span>
        </div>
        <hr />
        <div className="detail-main-content">
          ...
          perferendis doloribus asperiores repellat." Section "At vero eos et
          ...
          repellat." Section 1.10.33 of "de Finibus Bonorum et Malorum", written
          by Cicero in 45 BC "At vero eos et accusamus et iusto odio dignissimos
        ...
        <div className="seeBack">
          <FontAwesomeIcon
            className="seeBack-icon"
